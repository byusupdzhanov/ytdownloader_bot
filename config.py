...
texts = {
    'startMsgText': f'Привет! Я - бот для скачивания медиа с различных платформ!'
                    f'\n'
                    f'<b>Что я умею?</b>\n'
                    f'На данный момент, я нахожусь в этапе открытого beta-тестирования, поэтому функционал ограничен '
    ...
    'notready': f'К сожалению, данный раздел пока что в разработке😞\n'
